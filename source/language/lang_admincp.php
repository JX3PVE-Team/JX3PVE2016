...
(
	...
	'setting_home_base_new_user_type_realname' => '已经微信认证',
	...
	'setting_home_realname' => '微信认证',

	'setting_home_realname_switch' => '开启实名',

	'setting_home_realname_switch_comment' => '以下设置只有在开启实名机制后有效；<br/>注意，开启微信认证会增加服务器负担。 ',
...
<br />(3)SPH_RANK_NONE，禁用评分的模式，这是最快的模式。实际上这种模式与布尔搜索相同。所有的匹配项都被赋予权重1',
	...
	'members_verify_view_real_name_comment' => '该设置限制了未微信认证用户是否有权限查看认证通过的用户实名',
