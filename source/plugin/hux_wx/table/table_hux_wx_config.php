...
class table_hux_wx_config extends discuz_table
{
	...
	public function update_appver_configs_by_appid($appid,$value1,$value2) {
		return DB::query("UPDATE %t SET appver=%s,configs=%s WHERE appid=%s", array($this->_table, $value1, $value2, $appid));
	}
