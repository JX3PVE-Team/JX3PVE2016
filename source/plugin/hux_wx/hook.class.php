...
class plugin_hux_wx_forum extends plugin_hux_wx {

	function index_nav_extra() {
		global $_G;
		$appsns = C::t('#hux_wx#hux_wx_config')->fetch_by_appid('sns','appid');
		if ($appsns) {
			include DISCUZ_ROOT.'./source/plugin/hux_wx/mod/sns/hook.php';
		} else {
			$return = '';
		}
		return $return;
