...
function get_avatar_status($path){
	...
	//$host       = 'jx3pve.oss-cn-hangzhou-internal.aliyuncs.com';
	$access_id  = 'LTAIhr9lNg6KnufT';
	$access_key = 'qQbAEKUNpVQReUa6UP1rVHh0NOnelk';
	$bucket     = 'jx3pve2';
	...
	$uri = "http://jx3pve.oss-cn-hangzhou-internal.aliyuncs.com/avatar/".$path;
	$sign_string = "HEAD\n\n\n" . $date . "\n" . $uri;
	...
	//file_put_contents("/web/www/yylmacro/source/function/log.txt", $uri,  FILE_APPEND);
	if ($status == 200) {
		return true;
	} else {
		return false;
