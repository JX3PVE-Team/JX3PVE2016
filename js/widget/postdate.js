function IRX_postdate(){
	...
	$eachpost.each(function(i) {
		...
		var //最后编辑时间dom
			...
			//阅读数
			views = parseInt($.trim($(this).find('.u-views').text()))
		...
		if(valid > M_6){
			...
			$lastedit.addClass('new')	//1～3个月以内蓝色
		}else if(valid <= M_1){
			$lastedit.addClass('fresh')	//1个月以内绿色
		}else{
